...
public class DepthLimitedSearch<S,A> {
    ...
    public static final void main(final String[] args) {
        ...
        final DepthLimitedSearch<Puzzle8Board, AdyacentMovement> dfs = new DepthLimitedSearch<>(puzzle8Problem);
        final Node<Puzzle8Board, AdyacentMovement> ans = dfs.search(24).get();
